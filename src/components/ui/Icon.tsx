...
const paths: Record<IconName, React.ReactNode> = {
  ...
  /* Brand mark, filled rather than stroked like the rest of the set —
     fill/stroke are set explicitly here to override the outline defaults
     inherited from the parent <svg>. */
  linkedin: (
    <path
      fill="currentColor"
      stroke="none"
